...
namespace Meta
{
    ...
    internal class IDEBuildLogger : Logger, IDisposable
    {
        ...
        private string errorString = SystemResources.GetString(SystemResources.Error, CultureInfo.CurrentUICulture);
        private string warningString = SystemResources.GetString(SystemResources.Warning, CultureInfo.CurrentUICulture);
